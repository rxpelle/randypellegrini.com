---
date: 2026-03-13
title: "Can a Bioweapon Target Your DNA?"
heading: "Can a Bioweapon Target Your DNA? The Real Science Behind Genetically Targeted Weapons"
...
ctaButtonText: "Read The Genesis Protocol"
---
...
If this topic interests you, these are the sources I drew on while researching *The Genesis Protocol*:

- **"Synthetic Bioweapons Are Coming"** — U.S. Naval Institute *Proceedings*, June 2021. A military analysis of how synthetic biology is changing the bioweapons threat landscape.

- **"How to Protect the World from Ultra-Targeted Biological Weapons"** — *Bulletin of the Atomic Scientists*, December 2020. Examines the convergence of genomics, AI, and bioweapons potential.

- **"Top U.S. Intelligence Official Calls Gene Editing a WMD Threat"** — *MIT Technology Review*, February 2016. The article that first reported James Clapper's inclusion of CRISPR in the Worldwide Threat Assessment.

- **"CRISPR — A Weapon of Mass Destruction?"** — *Science* (AAAS). Explores the dual-use dilemma of CRISPR technology and the debate over gain-of-function research.

- **"Ethnic Bioweapon"** — Wikipedia. A surprisingly thorough overview of the history and science of genetically targeted weapons, with extensive citations.

- **"Redefining Biological Weapons in the Evolving AI, CRISPR, and Biothreat Landscape"** — *ScienceDirect*, 2025. The most recent academic assessment of how AI is accelerating biosecurity risks.
