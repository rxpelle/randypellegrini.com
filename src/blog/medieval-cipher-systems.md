...
1. **Colored inks** — standardized across European scriptoriums
2. **Geometric precision** — expected in manuscript illumination
3. **Physical decoding tools** — metal templates that frame specific marks while hiding others
